...
etcd-set /images/capcom                 "index.docker.io/behance/capcom:1a0fa9c13b0e098ed17b975a5221c188a85a05ad"
...
etcd-set /flight-director/config/aqua-enabled true
...
etcd-set /booster/config/nopersistence 'true'
